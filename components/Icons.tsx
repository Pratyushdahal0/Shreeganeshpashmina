...
export const Icon=({name,size='sm'}:{name:string,size?:'xs'|'sm'|'lg'})=>{const m:any={search:faMagnifyingGlass,bag:faBagShopping,chevron:faChevronDown,x:faXmark,bars:faBars,arrow:faArrowRight,left:faArrowLeft,minus:faMinus,plus:faPlus,trash:faTrash,globe:faGlobe,message:faMessage,location:faLocationDot,email:faEnvelope,chevronRight:faChevronRight,check:faCheck,instagram:faInstagram,facebook:faFacebookF,tiktok:faTiktok,whatsapp:faWhatsapp};return <FontAwesomeIcon icon={m[name]||faArrowRight} size={size}/>}
